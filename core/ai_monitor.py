...
class AIMonitor:
    ...
    def _build_prompt(snap: Dict[str, Any]) -> str:
        ...
        return (
            ...
            "Look for: stuck positions, position-mismatch flagged True, repeated OKX "
            "error codes (50102 clock drift, 50013 rate limit storms, 51169 reduce-only "
            "failures), engine stuck in a single state for an unreasonable period, "
            "or anything else suggesting the bot needs attention.\n\n"
